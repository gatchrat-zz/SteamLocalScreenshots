    ...
    var horst = setInterval(function () {
        ...
        if (document.getElementById("modalContentFrameContainer") != null) {
            ...
            for (var i = 0; i < matches2.length; i++) {
                ...
                if (matches2[i].href.indexOf("http://steamcommunity.com/profiles/") !== -1) {
                  
                    userid = matches2[i].href;
                    userid = userid.replace("http://steamcommunity.com/profiles/", "");
                    var link = userid;
                    gameid = link.split("=", 2)[1];
            ...
            if (document.location.href.indexOf("https") != -1) {
                ...
                document.getElementById("modalContentTitleBarLink").replaceWith(output);
